...
public interface Request {
    ...
    void createGameInLeague(GameDetails gameDetails, String leagueId);

    List<GameDetails> getAllLeagueGames(String leagueId);

    List<GameDetails> getAllLeagueGamesForTeam(String leagueId, String teamId);
